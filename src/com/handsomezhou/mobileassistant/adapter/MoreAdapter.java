...
public class MoreAdapter extends ArrayAdapter<IconButtonData> {
    private Context mContext;
    private int mTextViewResourceId;
    private List<IconButtonData> mIconButtonDatas;
    
    public MoreAdapter(Context context, int textViewResourceId, List<IconButtonData> iconButtonDatas) {
